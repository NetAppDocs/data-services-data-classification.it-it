...
La scansione limitata alla mappatura non riscalda i dati "freddi": questi rimangono tali e conservati in storage a oggetti. D'altra parte, se si esegue la scansione completa, alcune configurazioni potrebbero riscaldare i dati "freddi".
