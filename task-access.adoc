...
Attività specifiche richiedono ruoli utente specifici nella Console. link:https://docs.netapp.com/us-en/bluexp-setup-admin/reference-iam-predefined-roles.html["Scopri di più sui ruoli di accesso alla console per tutti i servizi"^] .

.Prima di iniziare
* link:https://docs.netapp.com/us-en/bluexp-setup-admin/concept-connectors.html["Dovresti aggiungere un agente Console."^]
