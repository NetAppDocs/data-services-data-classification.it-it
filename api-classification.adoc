...
Per accedere a Swagger, avrai bisogno dell'indirizzo IP della tua istanza di Data Classification. Nel caso di un'implementazione cloud, utilizzerai l'indirizzo IP pubblico. Quindi dovrai accedere a questo endpoint:
