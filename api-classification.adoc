...
summary: 'Le funzionalità di classificazione dei dati NetApp disponibili tramite l"interfaccia utente Web sono disponibili anche tramite l"API.' 
---
...
Le API nella documentazione di Swagger consentono di cercare, aggregare dati, monitorare le scansioni ed eseguire azioni come copia, spostamento e altro ancora.
