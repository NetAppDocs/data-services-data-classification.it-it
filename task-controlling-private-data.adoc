...
---
= Visualizza i dettagli di conformità relativi ai dati privati aziendali con NetApp Data Classification
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: I dettagli di conformità a livello di file sono disponibili solo se si esegue una scansione di classificazione completa. Le scansioni che si limitano alla mappatura non forniscono dettagli a livello di file.
...
+
image:screenshot_compliance_investigation_page.png["Uno screenshot delle informazioni dettagliate trovate nei file dopo aver selezionato Investigate Results."]

+
image:screenshot_compliance_investigation_page_directory.png["Uno screenshot delle informazioni dettagliate trovate nelle directory dopo aver selezionato Investigate Results."]
...
. Esamina i dati effettuando ricerche, ordinando, espandendo i dettagli di un file specifico, selezionando *Investigate Results* per visualizzare le informazioni mascherate oppure scaricando l'elenco dei file.
