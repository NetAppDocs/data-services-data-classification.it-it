...
[role="lead"]
NetApp Data Classification deve essere eseguito su un host che soddisfi specifici requisiti di sistema operativo, RAM e software. Quando implementi Data Classification nel cloud, usa un sistema con le caratteristiche "large" per avere la piena funzionalità.
