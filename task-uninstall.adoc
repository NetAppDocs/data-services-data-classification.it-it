...
. Selezionare **Disinstalla classificazione dati**.
...
. Nella finestra di dialogo, immettere "uninstall" per procedere con la disconnessione dell'istanza di Data Classification dall'agente della Console. Selezionare **Uninstall** per confermare.
