...
Se il sistema Azure NetApp Files che si desidera analizzare non è già presente nella console NetApp come sistema,link:https://docs.netapp.com/us-en/bluexp-azure-netapp-files/task-quick-start.html["aggiungilo nella pagina Sistemi"^] .
