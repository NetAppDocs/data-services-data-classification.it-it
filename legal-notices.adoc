...
* https://docs.netapp.com/us-en/bluexp-setup-admin/media/notice.pdf["Avviso per NetApp Console"^]
* link:media/notice-data-classification.pdf["Avviso per la classificazione dei dati NetApp"^]
