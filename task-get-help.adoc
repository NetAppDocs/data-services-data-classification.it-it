...
summary: 'NetApp fornisce supporto per la NetApp Console in vari modi. Sono sempre disponibili ampie opzioni di auto-supporto gratuite, come articoli della knowledge base (KB) e un forum della community. La registrazione al supporto include supporto tecnico remoto tramite ticket web.' 
---
