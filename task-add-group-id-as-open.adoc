...
summary: 'Quando gli ID di gruppo vengono associati a file o cartelle nelle condivisioni file NFS, definiscono le autorizzazioni per il file o la cartella. Se gli ID di gruppo non sono impostati sul livello di autorizzazione "Aperto all"organizzazione", è possibile aggiungere tale autorizzazione all"ID di gruppo in modo che tutti i file e le cartelle a cui è associato tale ID di gruppo vengano considerati "aperti all"organizzazione".' 
---
