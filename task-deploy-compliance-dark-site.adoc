...
[role="lead"]
Utilizza la modalità privata per installare NetApp Data Classification su un host Linux in una sede locale senza accesso a Internet. Questa implementazione utilizza uno script di installazione e mantiene l'istanza di Data Classification disconnessa dal layer SaaS di NetApp Console, permettendoti di analizzare le origini dati locali in un ambiente isolato.
