...
[role="lead"]
L'installazione di NetApp Data Classification su un host Linux in un sito locale che non dispone di accesso a Internet è nota come _modalità privata_.  Questo tipo di installazione, che utilizza uno script di installazione, non ha connettività con il livello SaaS della console NetApp .
