...
Lo script di installazione di Data Classification include uno script di test per garantire che l'ambiente soddisfi i requisiti. È possibile eseguire questo script separatamente per verificare la predisposizione dell'host Linux prima di eseguire lo script di installazione.
