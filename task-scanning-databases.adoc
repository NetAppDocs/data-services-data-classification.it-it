...
TIP: Non è disponibile un'opzione per selezionare solo le scansioni di mappatura per gli schemi del database.

. Dalla pagina di configurazione, seleziona il pulsante *Gestisci* relativo al database che desideri configurare.
+
...
. Per ogni schema per cui si desidera abilitare le scansioni, selezionare la colonna *Tipo di scansione* e quindi impostare la scansione su disattivata o **Scansione completa**.
