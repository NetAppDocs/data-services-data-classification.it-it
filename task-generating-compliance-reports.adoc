...
---
= Visualizza i report di conformità in NetApp Data Classification
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[NOTE]
====
* I report di conformità sono disponibili solo se si esegue una scansione di classificazione completa delle origini dati. Le origini dati per le quali è stata eseguita solo una scansione di mappatura possono generare esclusivamente il Data Mapping Report.
