...
. Per modificare il tipo di scansione per singoli bucket, condivisioni o volumi, seleziona la scheda **Scansioni attive**. Applica i filtri appropriati per identificare le risorse che vuoi modificare.
+
image:screenshot_compliance_config_button.png["Uno screenshot che mostra come selezionare il pulsante Configurazione per un sistema."]

+
Nella colonna Tipo di scansione, seleziona la risorsa designata e cambiala in **Solo mappatura** o **Scansione completa**.
...
.Passi
. Dal menu Classificazione dati, selezionare *Configurazione*.
. Seleziona la scheda **Scansioni attive**.
. Facoltativamente, applica i filtri appropriati per identificare le risorse che vuoi modificare. Trova le risorse a cui vuoi dare priorità. Seleziona l'opzione  `...` del menu azioni, poi *Scansione prioritaria*.
...
. Dal menu Classificazione dati, selezionare *Configurazione*.
. Seleziona la scheda **Scansioni attive**.
. Facoltativamente, applica i filtri appropriati per identificare le risorse che vuoi modificare. Identifica le risorse che vuoi mettere in pausa. Per ogni risorsa, seleziona l'opzione del menu azioni  `...` quindi *Metti in pausa scansione*.
+
