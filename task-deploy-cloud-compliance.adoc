...
Tieni presente che puoi anche link:task-deploy-compliance-onprem.html["installare Data Classification su un host Linux con accesso a Internet"]. Questo tipo di installazione può essere una buona opzione se preferisci eseguire la scansione dei sistemi ONTAP locali utilizzando un'istanza di Data Classification anch'essa locale, ma non è un requisito. Il software funziona esattamente allo stesso modo indipendentemente dal metodo di installazione che scegli.
...
Se non si dispone già di un agente Console, crearne uno. Vederelink:https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-aws.html["creazione di un agente Console in AWS"^] ,link:https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-azure.html["creazione di un agente Console in Azure"^] , Olink:https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-google.html["creazione di un agente Console in GCP"^] .

[role="quick-margin-para"]
Puoi anchelink:https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-on-prem.html["installare l'agente Console in locale"^] su un host Linux nella tua rete o su un host Linux nel cloud.

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["Due"]Prerequisiti
[role="quick-margin-para"]
Assicurati che il tuo ambiente possa soddisfare i prerequisiti. Questi includono outbound accesso a Internet per l'istanza, connettività tra l'agente Console e Data Classification sulla porta 443 e altro ancora. <<Prerequisiti,Vedi l'elenco completo>>.
...
Se non hai già un agente Console, creane uno nel tuo cloud provider. Vedi  https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-aws.html["creazione di un agente Console in AWS"^] o  https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-azure.html["creazione di un agente Console in Azure"^], oppure  https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-google.html["creazione di un agente Console in GCP"^]. Nella maggior parte dei casi, probabilmente hai già un agente Console configurato prima di provare ad attivare Data Classification perché la maggior parte  https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-on-prem.html["Le funzionalità della console richiedono un agente della console"], ma ci sono casi in cui devi configurarne uno ora.

Ci sono alcuni scenari in cui devi usare un agente Console distribuito in uno specifico cloud provider:
...
Nota che puoi anche https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-on-prem.html["installare l'agente Console in locale"^] su un host Linux nella tua rete o nel cloud. Alcuni utenti che intendono installare Data Classification in locale potrebbero anche scegliere di installare l'agente Console in locale.

Potrebbero esserci situazioni in cui è necessario utilizzare https://docs.netapp.com/us-en/console-setup-admin/concept-agents.html#multiple-systems-and-agents["più agenti della console"^] .
...
link:https://docs.netapp.com/us-en/console-setup-admin/task-install-restricted-mode.html["Scopri come distribuire l'agente Console in una regione governativa"^].
...
* link:https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-resource-limits.html["Documentazione AWS: quote di servizio Amazon EC2"^]
* link:https://docs.microsoft.com/en-us/azure/virtual-machines/linux/quotas["Documentazione di Azure: quote vCPU delle macchine virtuali"^]
* link:https://docs.cloud.google.com/docs/quotas/view-manage["Documentazione di Google Cloud: Quote di risorse"^]
